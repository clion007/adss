...
curl https://raw.gitmirror.com/clion007/adss/master/rules/file/dnsrules.conf -sLCSo /tmp/adss/dnsrules
curl https://raw.gitmirror.com/clion007/adss/master/rules/file/hostsrules.conf -sLCSo /tmp/adss/hostsrules.conf
echo 
