...
curl --http1.1 https://raw.kkgithub.com/clion007/adss/raw/master/rules/file/dnsrules.conf -sLSo /tmp/adss/dnsrules
curl --http1.1 https://raw.kkgithub.com/clion007/adss/raw/master/rules/file/hostsrules.conf -sLSo /tmp/adss/hostsrules.conf
echo 
