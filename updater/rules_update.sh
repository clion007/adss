...
curl https://raw.kkgithub.com/clion007/adss/master/rules/file/dnsrules.conf -sLSo /tmp/adss/dnsrules
curl https://raw.kkgithub.com/clion007/adss/master/rules/file/hostsrules.conf -sLSo /tmp/adss/hostsrules.conf
echo 
