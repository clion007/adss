...
if [ ! -s /tmp/copyright.sh ]; then
	wget --no-check-certificate https://gitee.com/clion007/dnsmasq/raw/master/copyright.sh -c -q -O \
...
echo
sleep 3
wget --no-check-certificate https://gitee.com/clion007/dnsmasq/raw/master/backup.sh -c -q -O \
	/tmp/backup.sh && chmod 775 /tmp/backup.sh && sh /tmp/backup.sh
rm -f /tmp/backup.sh
echo
sleep 3
wget --no-check-certificate https://gitee.com/clion007/dnsmasq/raw/master/modifyConfig.sh -c -q -O \
	/tmp/modifyConfig.sh  && chmod 775 /tmp/modifyConfig.sh  && sh /tmp/modifyConfig.sh
rm -f /tmp/modifyConfig.sh
wget --no-check-certificate https://gitee.com/clion007/dnsmasq/raw/master/initRulesFile.sh -c -q -O \
	/tmp/initRulesFile.sh  && chmod 775 /tmp/initRulesFile.sh  && sh /tmp/initRulesFile.sh
rm -f /tmp/initRulesFile.sh
echo
wget --no-check-certificate https://gitee.com/clion007/dnsmasq/raw/master/getDnsmasqAdRules.sh -c -q -O \
	/tmp/getDnsmasqAdRules.sh  && chmod 775 /tmp/getDnsmasqAdRules.sh  && sh /tmp/getDnsmasqAdRules.sh
rm -f /tmp/getDnsmasqAdRules.sh
echo
wget --no-check-certificate https://gitee.com/clion007/dnsmasq/raw/master/getHostsAdRules.sh -c -q -O \
	/tmp/getHostsAdRules.sh  && chmod 775 /tmp/getHostsAdRules.sh  && sh /tmp/getHostsAdRules.sh
rm -f /tmp/getHostsAdRules.sh
echo
wget --no-check-certificate https://gitee.com/clion007/dnsmasq/raw/master/deletWhiteListRules.sh -c -q -O \
