...
echo
wget --no-check-certificate https://raw.githubusercontent.com/clion007/dnsmasq/master/creatRulesFile.sh -c -O \
	/tmp/creatRulesFile.sh  && chmod 775 /tmp/creatRulesFile.sh  && sh /tmp/creatRulesFile.sh
	rm -f /tmp/creatRulesFile.sh
echo
