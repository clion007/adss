...
curl "https://pgl.yoyo.org/adservers/serverlist.php?hostformat=dnsmasq" -sLSo /tmp/adss/yoyoAd.conf
...
curl https://gitee.com/clion007/adss/raw/master/rules/adss/adblacklist -sLSo /tmp/adss/adblacklist
