...
echo
sleep 3
	wget --no-check-certificate https://gitcode.net/clion007/dnsmasq/raw/master/backup.sh -c -q -O \
		/tmp/backup.sh && chmod 775 /tmp/backup.sh && sh /tmp/backup.sh
	rm -f /tmp/backup.sh
echo
sleep 3
wget --no-check-certificate https://gitcode.net/clion007/dnsmasq/raw/master/modifyConfig.sh -c -q -O \
...
wget --no-check-certificate -c -q -O /etc/dnsmasq/fqad_update.sh https://gitcode.net/clion007/dnsmasq/raw/master/fqad_update.sh && chmod 755 /etc/dnsmasq/fqad_update.sh
echo
echo -e "\e[1;36m 获取规则更新脚本\e[0m"
wget --no-check-certificate -c -q -O /etc/dnsmasq/fqadrules_update.sh https://gitcode.net/clion007/dnsmasq/raw/master/fqadrules_update.sh && chmod 755 /etc/dnsmasq/fqadrules_update.sh
echo
sleep 3
...
wget --no-check-certificate -c -q -O /etc/dnsmasq/fqad_auto.sh https://gitcode.net/clion007/dnsmasq/raw/master/fqad_auto.sh
