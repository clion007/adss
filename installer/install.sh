...
curl --http1.1 https://gitcode.net/clion007/adss/raw/master/rules/file/dnsrules.conf -sLSo /etc/dnsmasq.d/adss/rules/dnsrules.conf
curl --http1.1 https://gitcode.net/clion007/adss/raw/master/rules/file/hostsrules.conf -sLSo /etc/dnsmasq.d/adss/rules/hostsrules.conf
