...
echo
sleep 3
wget https://gitee.com/clion007/adss/raw/master/config/backup.sh -qO \
	/tmp/adss/backup.sh && chmod 775 /tmp/adss/backup.sh && . /tmp/adss/backup.sh
rm -f /tmp/adss/backup.sh
echo
sleep 3
wget https://gitee.com/clion007/adss/raw/master/config/modifyConfig.sh -qO \
...
echo
wget https://gitee.com/clion007/adss/raw/master/rules/file/dnsrules.conf -qO \
	/usr/share/adss/rules/dnsrules.conf
wget https://gitee.com/clion007/adss/raw/master/rules/file/hostsrules.conf -qO \
...
sleep 3
wget https://gitee.com/clion007/adss/raw/master/config/cron.sh -qO \
