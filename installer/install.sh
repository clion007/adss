...
curl --http1.1 https://gh.llkk.cc/https://raw.githubusercontent.com/clion007/adss/master/rules/file/dnsrules.conf -sLSo /tmp/adss/dnsrules --retry 3 --retry-delay 2
